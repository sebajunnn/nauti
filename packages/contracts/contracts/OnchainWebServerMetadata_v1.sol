 ...
 */
contract OnchainWebServerMetadata_v1 is UUPSUpgradeable, OwnableUpgradeable {
    ...
    function updatePage(
        ...
        // Optionally, you can restrict access so that only the NFT contract can call this.
        pages[tokenId] = Page({ content: _content, name: _name, description: _description });
