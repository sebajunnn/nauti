...
contract OnchainWebServer_v4 is ERC721URIStorage, Ownable {
    using Strings for uint256;

    struct Page {
        string content;     // The actual code (HTML, JSX, TSX, or 3D model)
        string contentType; // "html", "jsx", "tsx", or "glb"
    ...
    function mintPage(
        ...
        require(
            ...
            keccak256(abi.encodePacked(_contentType)) == keccak256(abi.encodePacked("glb")),
