 ...
 */
contract OnchainWebServer_v7 is ERC721, Ownable {
    ...
    constructor(address _metadataContract) ERC721("Web3 Pages", "W3P") Ownable(msg.sender) {
    ...
    function mintPage(
        ...
        IMetadata(metadataContract).updatePage(tokenId, _content, _name, _description);
